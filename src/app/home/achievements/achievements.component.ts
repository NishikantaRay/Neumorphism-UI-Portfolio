...
export class AchievementsComponent implements OnInit {
  arrproject:any =[{
    ...
    "details":" The first, (currently only) and hands down BEST bootstrap 5 snippet extension. Includes templates, powerful utility snippets, and much more.",
  ...
  },
  {
    ...
    "details":" StudyTub is an online platform where you can get all engineering study material ,video lectures and assignment solution",
    "name":"Studytub ",
  ...
  },
  {
    ...
    "details":"To Control the black market of medicines, Control the production of Falsified drugs and provide real and trusted medicines to the buyer.",
